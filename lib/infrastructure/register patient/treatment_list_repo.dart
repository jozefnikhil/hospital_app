...
import 'package:amrita_treatment/domain/register%20patient/i_treatmentlist.dart';
import 'package:amrita_treatment/domain/register%20patient/treatmentlist/treatmentlist.dart';
import 'package:dio/dio.dart';
import 'package:flutter_secure_storage/flutter_secure_storage.dart';

class TreatmentListRepo implements ITreatmentlist {
  final FlutterSecureStorage _secureStorage = const FlutterSecureStorage();

  @override
  Future<Treatmentlist?> getTreatmentlist() async {
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        // Success
        final patientlist = Treatmentlist.fromJson(jsonData);
